...
<details>
<summary>✅ v2.0 First-Person Boxing (Phases 10–14) — SHIPPED 2026-05-17</summary>
...
- [x] **Phase 10: FPSBoxingPlugin** — New Rust crate implementing GamePlugin for fps_boxing rooms (completed 2026-05-13)
- [x] **Phase 11: Lobby + Room Updates** — Expose fps_boxing in the game picker and room page (completed 2026-05-13)
- [x] **Phase 12: FPS Client Scaffold** — New fps/ Vite app with WebSocket connection and webcam permission (completed 2026-05-13)
- [x] **Phase 13: MediaPipe + Calibration** — Webcam pose detection in a Web Worker with calibration step (completed 2026-05-13)
- [x] **Phase 13.1: Punch Classifier Model** — ml/ pipeline scaffold + usePunchClassifier hook (deferred to v3 — see BL-01)
